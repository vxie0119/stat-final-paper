...
injury.to_csv('data/InjuryRecord.csv', index=False)
```
# Modeling

```{python}
# Bar chart for frequency of each injury type in InjuryRecord
injury_freq = injury['BodyPart'].value_counts()
...
contingency_table = pd.crosstab(plays['InjuryOccurred'], injury['Surface'])
