...
+ Descriptive statistics to summarize the data, such as the injury counts by body part and the count of games played for each different sruface type.
